...
export default function PageHeader({
  ...
  return (
    <div className="relative h-[320px] sm:h-[380px] lg:h-[520px] w-full overflow-hidden">
      <div
      ...
      <div className="relative h-full flex items-center justify-start px-4 sm:px-6 lg:px-8">
        <div className=" max-w-4xl space-y-4">
          ...
          {description && (
            <p className="text-lg sm:text-xl uppercase font-thin text-slate-100 max-w-2xl mx-auto leading-relaxed">
              {description}
            </p>
          )}
        </div>
